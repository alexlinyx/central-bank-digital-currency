var ellipticCurve = require("elliptic").ec("secp256k1");
...
class ChainUtil {
  ...
  static keyPairFromPrivate(privateKey) {
    return ellipticCurve.keyFromPrivate(privateKey);
  }
  ...
  static verifySignature(publicKey, dataHash, signature) {
    return ellipticCurve.keyFromPublic(publicKey, "hex").verify(dataHash, signature);
  }
}
